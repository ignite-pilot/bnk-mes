export const menuConfig = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'inventory-finished-stock', label: '완제품 재고 업로드', path: '/inventory/finished-stock' },
      { id: 'inventory-semi-stock', label: '반제품 재고 업로드', path: '/inventory/semi-stock' },
      // { id: 'inventory-warehouse', label: '비엔케이 재고 창고 정보', path: '/inventory/warehouse' },
      { id: 'material-stock', label: '원자재 재고 업로드', path: '/material/stock' },
      { id: 'delivery-stock', label: '납품사 재고 업로드', path: '/delivery/stock' },
    ],
  },
];
